...
document.addEventListener('DOMContentLoaded', () => {
    document.getElementById('createLocationButton')?.addEventListener('click', openCreateModal);
    document.getElementById('refreshLocationsButton')?.addEventListener('click', loadLocations);
...
async function openEditModal(locationId) {
    showLoading();
    try {
        const response = await fetch(`${API_BASE_URL}/shipping-locations/${locationId}`);
...
async function saveLocation() {
    ...
    try {
        ...
        const url = locationId ? `${API_BASE_URL}/shipping-locations/${locationId}` : `${API_BASE_URL}/shipping-locations`;
