...
(function () {
  ...
  var PAGES = {
    ...
    'shipping-instruction-detail': { title: '出荷指示詳細', subtitle: '品目・ロット・QR検品・監査ログ' },
    'shipping-history':   { title: '出荷履歴', subtitle: '出荷指示・品目・ロット・QR/スキャン・監査ログ' },
    'shipping-report':    { title: '出荷帳票', subtitle: '出荷検品結果票・ロット別出荷実績票' },
    'traceability':       { title: 'トレーサビリティ', subtitle: 'ロット・QR・伝票・指図の横断追跡' },
    'production-plans':    { title: '生産計画', subtitle: '生産計画の管理' },
    'inventory':           { title: '在庫', subtitle: '在庫の照会' },
    'inventory-foundation': { title: '在庫・ロット・QR基盤', subtitle: '在庫残高・在庫移動・QR単位の横断照会' },
    'purchase-receiving':  { title: '発注・入庫', subtitle: '発注登録・入庫予定・QR/ロット入庫' },
    'sales-shipping':      { title: '受注・出荷指示', subtitle: '受注登録・出荷指示生成・出荷作業への連携' },
