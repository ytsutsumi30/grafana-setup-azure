...
export SUPABASE_ORG_ID='...'             # Supabase organization ID
export SUPABASE_DB_PASSWORD='...'        # New project DB password
export SUPABASE_PROJECT_NAME='shipping-inspection-poc'
...
`ash
export SUPABASE_DB_URL='postgresql://postgres.<project-ref>:<password>@aws-0-ap-northeast-1.pooler.supabase.com:5432/postgres?sslmode=require'
./scripts/apply-supabase-schema.sh
`
